...
abstract class BaseCompany extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Jay\\Bundle\\AdminBundle\\Model\\CompanyPeer';
    ...
    /**
     * The value for the company_key field.
     * @var        string
     */
    ...
    /**
     * The value for the company_status field.
     * @var        string
     */
    protected $company_status;

    /**
     * The value for the company_added_by field.
     * @var        int
     */
    protected $company_added_by;

    /**
     * The value for the company_date_added field.
     * @var        string
     */
    protected $company_date_added;
    ...
    /**
     * Get the [company_key] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [company_status] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [company_added_by] column value.
     *
     * @return int
     */
    public function getCompanyAddedBy()
    {

        return $this->company_added_by;
    }

    /**
     * Get the [optionally formatted] temporal [company_date_added] column value.
     *
     *
     ...
     */
    public function getCompanyDateAdded($format = null)
    {
        if ($this->company_date_added === null) {
            return null;
        }

        if ($this->company_date_added === '0000-00-00 00:00:00') {
        ...
        try {
            $dt = new DateTime($this->company_date_added);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->company_date_added, true), $x);
        }
    ...
    /**
     * Set the value of [company_key] column.
     *
     * @param  string $v new value
     * @return Company The current object (for fluent API support)
     */
    public function setCompanyKey($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->company_key !== $v) {
            $this->company_key = $v;
            $this->modifiedColumns[] = CompanyPeer::COMPANY_KEY;
        }
    ...
    /**
     * Set the value of [company_status] column.
     *
     * @param  string $v new value
     * @return Company The current object (for fluent API support)
     */
    public function setCompanyStatus($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->company_status !== $v) {
            $this->company_status = $v;
            $this->modifiedColumns[] = CompanyPeer::COMPANY_STATUS;
        }
    ...
    /**
     * Set the value of [company_added_by] column.
     *
     * @param  int $v new value
     * @return Company The current object (for fluent API support)
     */
    public function setCompanyAddedBy($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->company_added_by !== $v) {
            $this->company_added_by = $v;
            $this->modifiedColumns[] = CompanyPeer::COMPANY_ADDED_BY;
        }
    ...
    /**
     * Sets the value of [company_date_added] column to a normalized version of the date/time value specified.
     *
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return Company The current object (for fluent API support)
     */
    public function setCompanyDateAdded($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->company_date_added !== null || $dt !== null) {
            $currentDateAsString = ($this->company_date_added !== null && $tmpDt = new DateTime($this->company_date_added)) ? $tmpDt->format('Y-m-d H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->company_date_added = $newDateAsString;
                $this->modifiedColumns[] = CompanyPeer::COMPANY_DATE_ADDED;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->company_key = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->company_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->company_email = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->company_address = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->company_status = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->company_added_by = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->company_date_added = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = CompanyPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CompanyPeer::COMPANY_KEY)) {
            $modifiedColumns[':p' . $index++]  = '`company_key`';
        }
        if ($this->isColumnModified(CompanyPeer::COMPANY_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`company_name`';
        }
        if ($this->isColumnModified(CompanyPeer::COMPANY_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`company_email`';
        }
        if ($this->isColumnModified(CompanyPeer::COMPANY_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`company_address`';
        }
        if ($this->isColumnModified(CompanyPeer::COMPANY_STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`company_status`';
        }
        if ($this->isColumnModified(CompanyPeer::COMPANY_ADDED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`company_added_by`';
        }
        if ($this->isColumnModified(CompanyPeer::COMPANY_DATE_ADDED)) {
            $modifiedColumns[':p' . $index++]  = '`company_date_added`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`company_id`':
                        ...
                        break;
                    case '`company_key`':
                        $stmt->bindValue($identifier, $this->company_key, PDO::PARAM_STR);
                        break;
                    case '`company_name`':
                        $stmt->bindValue($identifier, $this->company_name, PDO::PARAM_STR);
                        break;
                    case '`company_email`':
                        $stmt->bindValue($identifier, $this->company_email, PDO::PARAM_STR);
                        break;
                    case '`company_address`':
                        $stmt->bindValue($identifier, $this->company_address, PDO::PARAM_STR);
                        break;
                    case '`company_status`':
                        $stmt->bindValue($identifier, $this->company_status, PDO::PARAM_STR);
                        break;
                    case '`company_added_by`':
                        $stmt->bindValue($identifier, $this->company_added_by, PDO::PARAM_INT);
                        break;
                    case '`company_date_added`':
                        $stmt->bindValue($identifier, $this->company_date_added, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 5:
                ...
                break;
            case 6:
                return $this->getCompanyAddedBy();
                break;
            case 7:
                return $this->getCompanyDateAdded();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getCompanyKey(),
            $keys[2] => $this->getCompanyName(),
            $keys[3] => $this->getCompanyEmail(),
            $keys[4] => $this->getCompanyAddress(),
            $keys[5] => $this->getCompanyStatus(),
            $keys[6] => $this->getCompanyAddedBy(),
            $keys[7] => $this->getCompanyDateAdded(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                $this->setCompanyStatus($value);
                break;
            case 6:
                $this->setCompanyAddedBy($value);
                break;
            case 7:
                $this->setCompanyDateAdded($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setCompanyKey($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setCompanyName($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setCompanyEmail($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setCompanyAddress($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setCompanyStatus($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setCompanyAddedBy($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setCompanyDateAdded($arr[$keys[7]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompanyPeer::COMPANY_KEY)) $criteria->add(CompanyPeer::COMPANY_KEY, $this->company_key);
        ...
        if ($this->isColumnModified(CompanyPeer::COMPANY_STATUS)) $criteria->add(CompanyPeer::COMPANY_STATUS, $this->company_status);
        if ($this->isColumnModified(CompanyPeer::COMPANY_ADDED_BY)) $criteria->add(CompanyPeer::COMPANY_ADDED_BY, $this->company_added_by);
        if ($this->isColumnModified(CompanyPeer::COMPANY_DATE_ADDED)) $criteria->add(CompanyPeer::COMPANY_DATE_ADDED, $this->company_date_added);
    ...
    {
        $copyObj->setCompanyKey($this->getCompanyKey());
        $copyObj->setCompanyName($this->getCompanyName());
        $copyObj->setCompanyEmail($this->getCompanyEmail());
        $copyObj->setCompanyAddress($this->getCompanyAddress());
        $copyObj->setCompanyStatus($this->getCompanyStatus());
        $copyObj->setCompanyAddedBy($this->getCompanyAddedBy());
        $copyObj->setCompanyDateAdded($this->getCompanyDateAdded());
     ...
     * @return PropelObjectCollection|User[] List of User objects
     */
    public function getUsersJoinUserLevel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UserQuery::create(null, $criteria);
        $query->joinWith('UserLevel', $join_behavior);
    ...
    public function clear()
    {
        ...
        $this->company_added_by = null;
        $this->company_date_added = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
